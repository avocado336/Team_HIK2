...
//	
//	// ログイン画面
//	public static final String LOGIN1 = "/login1_move";
//	
//	// 新規会員登録画面
//	public static final String REGISTER = "/register_move";
//	
//	// ログイン画面（新規会員登録画面から戻るボタンで遷移するログイン画面）
//	public static final String LOGIN2 = "/login2_move";
//	
//	// TOP画面（ログイン画面からログインが完了した後に遷移するTOP画面）
//	public static final String TOP1 = "/top1_move";
//	
//	// TOP画面（新規会員登録画面から登録が完了した後に遷移するTOP画面）
//	public static final String TOP2 = "/top2_move";
//	
...
//	
//	// 登録完了画面
//	public static final String ENDSCREEN = "/endScreen_move";
//	
